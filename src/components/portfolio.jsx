...
//import stock
import stock from "../img/FortressOfFandom.png";
import stock1 from "../img/RecipeRoundup.png";
import stock2 from "../img/HolidayPlanner.png";
import stock3 from "../img/BudgetTracker.png";
import stock4 from "../img/NoteTaker.png";
import stock5 from "../img/PizzaHunt.png";
            ...
            <div className="col-sm-12">
              <div className="title-box text-center">
                ...
                <p className="subtitle-a">
                  These are some of the projects that I've worked on throughout my time at the University of Utah Full Stack Web Development Bootcamp.
                </p>
                  ...
                  <div className="work-content">
                    <div className="row">
                      <div className="col-sm-8">
                        <h2 className="w-title">Fortress of Fandom</h2>
              ...
              <div className="work-box">
                <a href="https://github.com/ThomasNguyen546/Recipe-Finder">
                  ...
                  <div className="work-content">
                    <div className="row">
                      <div className="col-sm-8">
                        <h2 className="w-title">Recipe Roundup</h2>
                        <div className="w-more">
                          <span className="w-ctegory">
              ...
              <div className="work-box">
                <a href="https://github.com/ThomasNguyen546/holiday-planner">
                  ...
                  <div className="work-content">
                    <div className="row">
                      <div className="col-sm-8">
                        <h2 className="w-title">Holiday Planner</h2>
                        <div className="w-more">
                          <span className="w-ctegory">
                            Website to Plan Holidays
                          </span>
                  ...
                  <div className="work-content">
                    <div className="row">
                      <div className="col-sm-8">
                        ...
                        <div className="w-more">
                          <span className="w-ctegory">
                            Application to Budget Finances
                          </span>
                        </div>
                      </div>
                      <div className="col-sm-4">
                  ...
                  <div className="work-content">
                    <div className="row">
                      <div className="col-sm-8">
                        ...
                        <div className="w-more">
                          <span className="w-ctegory">Application to Take and Save Notes</span>
                        </div>
                      </div>
                      <div className="col-sm-4">
                        <div className="w-like">
              ...
              <div className="work-box">
                <a href="https://github.com/ThomasNguyen546/Pizza-Hunt">
                  ...
                  <div className="work-content">
                    <div className="row">
                      <div className="col-sm-8">
                        <h2 className="w-title">Pizza Hunt</h2>
                        <div className="w-more">
                          <span className="w-ctegory">
                            Pizza Hunt Website
                          </span>
